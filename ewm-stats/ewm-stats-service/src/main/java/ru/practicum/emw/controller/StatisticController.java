...
public class StatisticController {
    ...
    @PostMapping("/hit")
    public StatisticCreateDataDto save(@RequestBody @Valid StatisticCreateDataDto statData) {
        log.info("Поступил POST-запрос в /hit");
        StatisticCreateDataDto statisticCreateDataDto = statisticService.save(statData);
        log.info("POST-запрос /hit был обработан: {}", statisticCreateDataDto);
        return statisticCreateDataDto;
    }
